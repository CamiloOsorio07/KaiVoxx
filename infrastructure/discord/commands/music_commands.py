...
@bot.event
async def on_wavelink_track_end(player: wavelink.Player, track, reason: str):
...
@bot.event
async def on_wavelink_track_exception(player: wavelink.Player, track, error: Exception):
