...
- [x] Reemplazar el cliente TTS en infrastructure/tts/gtts_client.py para usar ElevenLabs en lugar de gTTS
...
- [x] Probar la implementación: Bot se conectó, error de import corregido
